...
function alterego_scripts() {
	...
	wp_enqueue_style( 'alterego-tachyons', get_template_directory_uri() . '/css/tachyons.css', array(), _S_VERSION );

	wp_enqueue_style( 'alterego-custom', get_template_directory_uri() . '/css/custom.css', array(), _S_VERSION );

	wp_enqueue_style( 'alterego-fonts', get_template_directory_uri() . '/css/fonts.css', array(), _S_VERSION );

	wp_enqueue_script( 'alterego-marquee', get_template_directory_uri() . '/js/marquee.js', array(), _S_VERSION );
